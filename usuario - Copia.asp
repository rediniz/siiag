...
if cStr(request("flg_salvar")) = "1" then
	...
	elseif request.Cookies("ic_gerente_siiag") and not request.Cookies("usuario_admin_siiag") then
      ...
      <div class="conteudo">
        <div class="usuariodiv">
          <div id='cssmenu'>
			...
			<%	if  request.Cookies("usuario_admin_siiag") or request.Cookies("ic_gerente_siiag") then %>
		  ...
		  <%if request.Cookies("usuario_admin_siiag") or (request.Cookies("ic_gerente_siiag") or request.Cookies("co_usuario_siiag") = matricula ) then%>
            <tr>
                <td>
