...
<%
		query = "SELECT NO_NOME,  DE_RESPONSAVEL,CO_MATRICULA_RESPONSAVEL, DE_OBS,DH_INICIO, DH_FIM  FROM TB_EMPRESTIMO LEFT JOIN VW_USUARIOS ON CO_MATRICULA= CO_MATRICULA_RESPONSAVEL WHERE CO_EMPRESTIMO="&request("co_emprestimo")
