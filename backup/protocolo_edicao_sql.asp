...
'			arquivo.FileName
		...
		sql3 = "INSERT INTO TB_PROTOCOLO_ARQUIVOS (NO_PROTOCOLO,AA_PROTOCOLO,CO_TIPO,NO_ARQUIVO,SG_EXTENSAO,VR_TAMANHO_KB,CO_CRIADOR,DH_CRIACAO,CO_AREA) VALUES ("&	numeroProtocolo&",'" & year(date()) & "'," &codTipoProtocolo& ",'" & arquivo.FileName & "','" & extensao & "',"& tamanho_arquivo & ",'" & request.Cookies("co_usuario_siiag") & "','" & data & "'," & areaProtocolo & ")"
