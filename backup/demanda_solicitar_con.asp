...
<%
	...
	IF tipoDemanda = 2 THEN
		...
		query = "INSERT INTO TB_DEMANDAS (SOLICITACAO_DATA, SOLICITACAO_MATRICULA, TIPO_DEMANDA, CO_APLICATIVO, DESCRICAO, ORDEM_PRIORIDADE) VALUES ('" & data & "', '" & matricula & "', " & tipoDemanda & ", " & co_aplicativo & " , '" & descricao & "', " & qt_erro + 1 & ")"
	...
	ELSE
		...
		query = "INSERT INTO TB_DEMANDAS (SOLICITACAO_DATA, SOLICITACAO_MATRICULA, TIPO_DEMANDA, CO_APLICATIVO, DESCRICAO, ORDEM_PRIORIDADE) VALUES ('" & data & "', '" & matricula & "', " & tipoDemanda & ", " & co_aplicativo & " , '" & descricao & "', " & prioridade & ")"
		'RESPONSE.WRITE QUERY
		objConn.execute(query)
