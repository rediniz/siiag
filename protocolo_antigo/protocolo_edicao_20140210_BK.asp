...
<span class="style4 style2">
            ...
            <tr>
              ...
              <td><select style="margin-left:2px;padding-right:2.5px;" id="tipoProtocolo" disabled='disabled' name="tipoProtocolo" onchange="habilitaAR();">
                   <option value="">Selecione o Tipo de Protocolo</option>
                    ...
                    DO UNTIL ds.eof
						...
						if(tipoProtocolo = request("tipoProtocolo")) then
				       response.write "<option selected='selected' name ="&codigoTipoProtocolo&" value="& codigoTipoProtocolo &">"&tipoProtocolo&"</option>"	
				else
             ...
             <td><label>&Aacute;rea: </label></td>
              <td>    
            <select id="areaProtocolo"  name="areaProtocolo" disabled='disabled'>
            ...
            DO UNTIL ds.eof
				...
				nomeArea=ds("NO_AREA")
				if(nomeArea = request("areaProtocolo")) then
				response.write "<option selected='selected' value="& codigoArea &" >"&nomeArea&"</option>"	
				else
...
-->           
     ...
     <div id="arquivos_relacionados">
          ...
          <div align="center" class="tabela" ="margin-left:0.8%; margin-bottom:3%; width:300px" >
            <table style="width:660px">
              <tr>
                <td width="20%">Nome</td>
                <td width="1%" >Extensao</td>
                <td width="1%">Tamanho</td>
                <td width="2%" >Criador</td>
                <td width="9%">Data de Criação</td>
              </tr>
              <%

			
			  	QueryNoProtocolo = "select AA_PROTOCOLO, no_protocolo from TB_PROTOCOLO_ATUAL where co_sequencial = "&request("codSeq")&""
	...
	QueryArquivo ="select * from TB_PROTOCOLO_ARQUIVOS WHERE NO_PROTOCOLO ="&noProtocolo&" AND AA_PROTOCOLO="&aaProtocolo&""
  ...
  do UNTIL rsArquivo.eof
	...
	arquivo_criador = rsArquivo("CO_CRIADOR")
 	arquivo_data = rsArquivo("DH_CRIACAO")
	                	response.write "<tr>"
                        response.write "<td id='arquivo_nome' >"& arquivo_nome & "</td>"
