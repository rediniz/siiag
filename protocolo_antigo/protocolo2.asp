...
<span class="style4 style2">
            ...
            <form ACTION="protocolo_salvar2.asp" name="formProtocolo" enctype="multipart/form-data" method="POST" >
            ...
            <tr>
              ...
              <td><p>
                ...
                <p>
                  <label>Nº AR</label>
                  <input class="form-field" type="text" name="numeroAR" id="numeroAR" disabled="disabled" size="10px" maxlength="9" style="width:85px" value=" "/>
                  <input type="hidden" name="numero_ar" id="numero_ar" />
                </p></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3"><select id = "responsavelProtocolo" name = "responsavelProtocolo" style="margin-left:2px;padding-right:2.5px;">
              <option> </option>
              <%
			  Query4 ="select NO_NOME from TB_USUARIOS WHERE IC_ATIVO=1 ORDER BY NO_NOME" 
             set objConn = server.CreateObject("ADODB.Connection") 
            ...
            ds.Open Query4, dados_sys 
            DO UNTIL ds.eof
				nomeResponsavel=ds("NO_NOME")
				response.write "<option value='"&nomeResponsavel&"'>"&nomeResponsavel&"</option>"							 
				ds.movenext
            LOOP
            set ds = nothing
			  %>
              ...
              <input type="hidden" name="f_responsavel_matricula" id="f_responsavel_matricula"></td>
            </tr>
     <!-- 
            <tr>
...
-->           
    ...
    <p/>
      <label>Arquivos:&nbsp;</label>
          <div  style="background-color:#F3F3F3; width:500px; border-radius: 4px;" >
     	<p/>
