...
<%
	...
	sql = "INSERT INTO TB_PROTOCOLO_ATUAL (NO_PROTOCOLO,AA_PROTOCOLO,DH_ENVIO, CO_MATRICULA_INCLUSAO, CO_RESPONSAVEL_MATRICULA, NO_RESPONSAVEL,DE_CONTEUDO,DE_DESTINO,CO_TIPO,CO_AREA,CO_UNIDADE_FGTS) VALUES (" & numeroProtocolo &" ," & 	year(date()) &",'" & data & "','" & request.Cookies("co_usuario_protocolo") & "','" & co_responsavel_matricula & "','" & responsavelProtocolo &"','" & conteudoProtocolo &"','" & destinoProtocolo &"'," & tipoProtocolo &"," & areaProtocolo &",7180)"
