...
<span class="style4 style2">
            ...
            <form ACTION="protocolo_editar_teste.asp" name="formProtocolo" method="POST">
...
'				end if
            ...
            <tr>
              ...
              <td colspan="3"><input class="form-field" name="responsavelProtocolo" id="responsavelProtocolo" size="75" maxlength="300" type="text" onchange="ChamarLink();" value="<% response.write(request("responsavel"))%>"/><input type="hidden" name="f_responsavel_matricula" id="f_responsavel_matricula" ></td>
            </tr>
     <!-- 
            <tr>
