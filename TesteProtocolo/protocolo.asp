...
<span class="style4 style2">
            ...
            <tr>
              ...
              <td colspan="3"><input class="form-field" name="responsavelProtocolo" id="responsavelProtocolo" size="75" maxlength="300" type="text" onchange="ChamarLink();" /></td>
            </tr>
     <!-- 
            <tr>
