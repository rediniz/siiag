  ...
  <div class="corposite">
    ...
    <div class="container">
      <div class="conteudo">
        ...
        <input type="text" id="dataFinal" class="datepicker" onchange="ChamarLink();"> 
   ...
   <script language="javascript">
    function ChamarLink() {
		...
		$("a.myButton").replaceWith("<a class='myButton' style='link-style:none;color:white;margin-left:9.3%;' href='geraRelatorio.asp?dataInicial="+dataInicial+"&dataFinal="+dataFinal+"'>Gerar Relat&oacute;rio</a>");
    ...
    <a class="myButton" style="link-style:none;color:white;margin-left:9.3%;">Gerar Relat&oacute;rio</a>
