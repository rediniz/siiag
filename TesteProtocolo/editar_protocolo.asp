...
<span class="style4 style2">
            ...
            <tr>
              ...
              <td><select style="margin-left:2px;padding-right:2.5px;" id="tipoProtocolo" name="tipoProtocolo" onchange="ChamarLink();">
            ...
            %>
              ...
              <td>    
            <select id="areaProtocolo"  name="areaProtocolo" onchange="ChamarLink();">
            ...
            <tr>
              ...
              <td><p>
                <input type="checkbox" name="add_AR" id="addAR" disabled="disabled" onchange="adicionarAR()" />
            ...
            <tr>
              ...
              <td><input class="form-field" name="destinoProtocolo" id="destinoProtocolo" type="text" size="47" maxlength="100" onchange="ChamarLink();" /></td>
            </tr>
            <tr>
              <td><label>Conte&uacute;do: </label></td>
              <td><textarea class="form-field" name="conteudoProtocolo" id="conteudoProtocolo" style="max-height:39px;min-height:39px;max-width:306px;min-width:306px;" onchange="ChamarLink();"  ></textarea></td>
            </tr>
            <tr>
              <td align="right"> <label>Respons&aacute;vel:</label></td>
              <td><input class="form-field" name="responsavelProtocolo" id="responsavelProtocolo" size="47" maxlength="300" type="text" onchange="ChamarLink();" /></td>
            </tr>
            <tr>
    ...
    <div id="receberLink"></div>
     ...
     <input type ="submit" class="myButton" id='salvar' style='margin:16px;' value="Salvar">
		...
		response.write("<p style='color:green; font-size: 16px'>Protocolo incluido com sucesso.</p>")
		
		else
		
		if( sucesso="false" ) then
		
		response.write("<p style='color:red; font-size: 16px'>Erro ao incluir protocolo.</p>")
