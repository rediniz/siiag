...
//	   window.location.assign("protocolo_consultar.asp?todos=1");
	   ...
	   window.location.assign("protocolo_consultar.asp?tipoProtocolo="+tipoProtocolo+"&areaProtocolo="+areaProtocolo+"&dataInicial="+dataInicial+"&dataFinal="+dataFinal+"&numeroOficio="+numeroOficio+"");
...
<script>
	...
	$(document).ready(function() {
		...
		$('.tabela').on('click', '#X', function(){
			...
			var tipoProtocolo = $('#codTipo').text();
			var areaProtocolo = $('#codArea').text();
			var numeroOficio = $('#numOficio').text();
		
		$(this).parent().parent().remove();
			

			//alert("Tipo de Protocolo: "+tipoProtocolo+" Area de Protocolo: "+ areaProtocolo+" e Numero Oficio:"+numeroOficio);
		window.location.assign("protocolo_excluir.asp?query='delete'&numeroOficio="+numeroOficio+"&codigoArea="+areaProtocolo+"&tipoProtocolo="+tipoProtocolo+"");
		});
...
//			var nomeResponsavel = $('#nomeResponsavel').text();
//		
//		
//		
//		
...
//
//			//alert("Tipo de Protocolo: "+tipoProtocolo+" Area de Protocolo: "+ areaProtocolo+" e Numero Oficio:"+numeroOficio);
//		window.open("editar_protocolo.asp?numeroOficio="+numeroOficio+"&codigoArea="+areaProtocolo+"&tipoProtocolo="+tipoProtocolo+"&destino="+destino+"&conteudo="+conteudo+"nomeResponsavel="+nomeResponsavel+"");
//		});
//		
...
<div class="teste">
  <!--fundo azul do meio-->
  <!-- #INCL UDE FILE ="topo_protocolo.asp" -->
  ...
  <div class="corposite">
    ...
    <div class="container">
      <div class="conteudo2">
        <div class="usuariodiv">
          ...
          <legend class="style2 style3">Consulta de Protocolos</legend>
           ...
           <div class="numeroClasse">  
             <label>N&uacute;mero:</label>
             <input name="numeroOficio" class="efeitoNumero" id="numeroOficio" type="text" style=" width:182px;max-width:182px;min-width:182px;" size="27" maxlength="1000" onchange="ChamarLink()" value="<%=request("numeroOficio")%>"/> 
           </div>
           <br/>
           
           <br/>
          <div class="areatipo"><!-- area tipo -->
          <label>Tipo: </label>
          		<select id="tipoProtocolo" class="efeitoTipo" style=" width:220px;max-width:220px;min-width:220px;" name="tipoProtocolo"  onchange="ChamarLink();">
          ...
          <label>&Aacute;rea:</label>
          		...
          		<select id="areaProtocolo" class="efeitoArea" style="margin-top:5px;margin-left:5px;width:220px;max-width:220px;min-width:220px;height:30px;" name="areaProtocolo" onchange="ChamarLink();">
        ...
        <br/><br/><br/><br/> <br/>
          ...
          <div class="periodoClasse"> <!-- inicio periodoClasse -->
          <label>De:</label>
          ...
          <label>At&eacute;:</label>
           ...
           </div> <!-- fim do periodoClasse -->            
                        
             
 
             

          <input name="" value="Pesquisar" class="myButton" style="float:right;margin-right:45%;" type="button" onclick="pesquisar()" />
     ...
     <div class="tabela" style="margin-left:0.8%;" >
 	 ...
 	 <!-- #IN CLUDE FILE ="consultas_protocolo.asp" -->
