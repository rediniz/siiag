	...
	$("#nome").result(function(event, retorno) {
	 ...
	 $("#matricula").result(function(event, retorno) {
		...
		if (retorno==undefined)
			...
			$("#foto").attr("src", "imagens//usuarios//" + retorno[0] + "");
			}	
        ...
        <div class="usuariodiv">
          ...
          <p class="paragrafoteste style2"> <span class="style4 style2">
             ...
             <td colspan="5">
                ...
                <td width="18%" rowspan="5"  align="center" valign="middle" >
				 <!-- <img style='border:#b9d3f0 solid 3px;'id='foto' src='imagens//usuarios//<% =matricula%>.png' /> -->
				  ...
				  <%else%>
    	              <img style='border:#b9d3f0 solid 3px;'id='foto' src='imagens//usuarios//<% =imagem%>' width="103" height="128" />
                  <%end if%>
              </td>
            ...
            <tr>
				...
				<td width="10%" >
                  <input class='campo_bloqueado' name='nascimento' id='nascimento' type='text'  size='10' maxlength='10' value='<%=nascimento %>' disabled="disabled"
                  />
			  </td>
				...
				<td width="21%" >
                  <input class='campo_bloqueado' name='admissao' id='admissao' type='text'  size='10' maxlength='10'  value='<%= admissao %>' disabled="disabled" />
			  </td>                
                <td width="12%">
	            <label >Início: </label>
              </td>
				<td width="23%" >
                  <input class='campo_bloqueado' name='inicio' id='inicio' type='text'  size='10' maxlength='10' value='<%= inicio %>' disabled="disabled" />
			  </td>
            </tr>
            <tr>
                <td>
				...
				<td width="10%"  colspan="6" >
                  <input class='campo_bloqueado' name='jornada' id='jornada' type='text'  size='8' maxlength='10' value='<% = jornada %>" horas' disabled="disabled" />
			  </td>
