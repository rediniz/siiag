...
<%	
	...
	'#Alterado em 21/03/2016 ------------------------------
	'set objConn = nothing 'deixar comentado
	
	'#Alterado em 21/03/2016 ------------------------------
	if prazoCritico = "true" then
		enviaEmailPrazoCritico(usuario)
	end if
	'------------------------------------------------------
	...
	Sub enviaEmailPrazoCritico(matricula_usuario)
		...
		vTexto = "<body>" &_
				...
				"<p align=""left""><b>Atenção, prazo crítico!</b></p>" &_
				"<p align=""left"">Prezado(a) "&nome&" </p>" &_
				"<p>Favor contatar a coordenação Informações e Apoio à Gestão para confirmar a viabilidade do destacamento no período solicitado.</p>" &_
				"<p>Atenciosamente,<br /><br />Informações e Apoio à Gestão <br/>GI Fundo de Garantia Fortaleza/CE</p>" &_
				"</font>" &_
				"</body>" &_
				"</html>"
