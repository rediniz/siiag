...
/*			document.getElementById('chk_matricula').checked = 'true';*/
			...
			document.getElementById('chk_cargo').checked = 'true';
			...
			document.getElementById('chk_cargo').checked = '';
...
*/
		...
		if (marcou_coord == false)
		{
			alert ("Nenhuma Coordenação foi marcada!");
			return false;
		}

		if( document.getElementById('chk_nome').checked == '' && document.getElementById('chk_coordenacao').checked == '' && document.getElementById('chk_assinatura').checked == ''){
			alert ("Nenhum campo foi marcado!");
			return false;
		}
					        ...
					        <fieldset class="testess" style=" border-color: #FFCC66; border:#FFCC66 1px solid; border-radius:4px;">
						        ...
						        <form name="form_exibir" id="form_exibir" action="usuario_relatorio_frequencia.asp" method="post" target="_blank" >
						            <table border="0" width="100%">
							            <tr>
								            <td width="9%" >	<label >T&iacute;tulo: </label>		</td> 
                                    		<td colspan="3">
								            ...
								            <td colspan="6" class="check">
									            <fieldset class="testess" style=" border-color: #999999; border:#999999 1px solid; border-radius:4px;">
										            ...
										            <%
														...
														strQuery = "SELECT DISTINCT CO_GS, NO_GS FROM VW_gs WHERE CO_UNIDADE = '" & request.Cookies("co_usuario_unidade_siiag") & "' ORDER BY NO_GS "
														...
														do while not rs.eof
															...
															response.write "<td width='33%' ><input class='chk_coord' type='checkbox' name='chk_coord_" & cont & "' id='chk_coord_" & cont & "' value='" & rs("co_GS") & "' onclick='return(verifica_coordenacao())'/>" & rs("no_GS") & "</td>"
														...
														loop
														cont = cont + 1
														response.write "<td width='33%' ><input class='chk_coord' type='checkbox' name='chk_coord_" & cont & "' id='chk_coord_ " & cont & "' value='99999' onclick='return(verifica_coordenacao())'/>SEM COORDENAÇÃO</td>"
														response.write "</table>"
													%>
													<input type="hidden" name="qt_coordenacoes" id="qt_coordenacoes" value="<%=cont%>" />
                                  					...
                                  					<table>
                                                        <tr>
                                                          <!--  <td width="170"> <input  type='checkbox' name='chk_matricula' id='chk_matricula' /> Matrícula </td>-->
                                                            ...
                                                            <td width="170"> <input  type='checkbox' name='chk_cargo' id='chk_cargo' /> Cargo </td>
            			                        ...
            			                        <td colspan="6" class="check">
                        				            <fieldset class="testess" style=" border-color: #999999; border:#999999 1px solid; border-radius:4px;">
                                                        ...
                                                        <%
                                                        	...
                                                        	set rs = server.CreateObject("ADODB.RecordSet")
	                                                        strQuery = "SELECT DISTINCT CO_CARGO, NO_CARGO FROM VW_USUARIOS WHERE CO_UNIDADE = '" & request.Cookies("co_usuario_unidade_siiag") & "' ORDER BY NO_CARGO "
    	                                                    'RESPONSE.WRITE strQuery
        	                                                rs.Open strQuery, dados_sys
                    	                                    ...
                    	                                    do while not rs.eof
                        		                                cont = cont + 1
                                		                        if cont mod 4 = 1 then
                                        			                response.write "<tr>"
                                                    		    end if		
		                                                        response.write "<td width='25%' ><input class='chk_cargo' type='checkbox' name='chk_cargo_" & cont & "' id='chk_cargo_" & cont & "' value='" & rs("co_cargo") & "' onclick='return(verifica_cargos())'/>" & Capitalize(rs("no_cargo")) & "</td>"
                                                	        ...
                                                	        response.write "</table>"
                                                        %>
                                                        <input type="hidden" name="qt_cargos" id="qt_cargos" value="<%=cont%>" />
<!--             	<table>
                 <tr>
                   <td width="200"></td>
    ...
    -->            
              						...
              						<tr> <td class="check" colspan="2">
                                        <fieldset class="testess" style=" border-color: #999999; border:#999999 1px solid; border-radius:4px;">
										            <legend >Sexo:</legend>
                                                    <table width='100%' border="0"><tr><td width="33%">
           											<input class='chk_sexo' type='checkbox' name='chk_sexo_M'  value='M' />Masculino
                                                    </td>
                                                    <td>
													<input class='chk_sexo' type='checkbox' name='chk_sexo_F'  value='F' />Feminino			</td></tr></table>
                                    		</fieldset>  
                                        </td>
                                        </tr>
						            <tr>
