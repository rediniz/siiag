...
<%	
	...
	sub reconhecer()
		...
		queryReconhecimento = "update tb_colaboracao_pedido set mensagem_reconhecimento = '"&mensagem&"' where id = "&pedido&""
		
		objConn.execute(queryReconhecimento)
		
		'enviarEmailEmpregado(empregado)
	
	end sub
	
	'sub enviarEmailEmpregado(empregado)
'	
