...
window.location.assign("protocolo_excluir_arquivo.asp?arquivo="+arquivo+"&nome_arquivo="+nome_arquivo+"&aa_protocolo="+aa_protocolo+"&cod_tipo="+cod_tipo);
     ...
     <div id="arquivos_relacionados">
          ...
          <div align="center" class="tabela" style="margin-bottom:3%; width:300px" >
			...
			do UNTIL rsArquivo.eof
				...
				response.write "<tr>"
				response.write "<td id='arquivo_nome' ><a id = 'arquivo' href='\\ce7180nt005\Aplicativos\Programas\Relatório Protocolo\"& aaProtocolo & "-" & codTipo & "-" &noProtocolo & "\" & arquivo_nome & "'>"&arquivo_nome&"</a><input type='hidden' id='aaProtocolo' value='"&aaProtocolo&"'/><input type='hidden' id='codTipo' value='"&codTipo&"'/></td>"
