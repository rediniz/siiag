...
//	   window.location.assign("protocolo_consultar.asp?todos=1");
	   ...
	   window.location.assign("protocolo_consultar.asp?tipoProtocolo="+tipoProtocolo+"&areaProtocolo="+areaProtocolo+"&dataInicial="+dataInicial+"&dataFinal="+dataFinal+"&numeroOficio="+numeroOficio+"&f_responsavel_matricula="+responsavel_matricula+"&f_chk_base_antiga="+f_chk_base_antiga+"");
	   }
...
%>
<body>
<div class="teste2" style="border:#FFffff solid 1px;"  >
  <!--fundo azul do meio-->
  <!-- #INCLUDE FILE ="topo_protocolo.asp" -->
 
  <div class="corposite" style="border:# solid 1px;">
    <!--corpo-->
   <div class="container" style="border:#FFff00 solid 1px; margin-top:0px;"  >
      <div class="conteudo2" style="border:#FF0000 solid 1px;" >
