...
sub Login
	...
	' CONSISTE USUÁRIO
	'================================================
	Session("v_Usuario_Funcao") = wUserDescription
	Session("v_Usuario_Matricula") = ucase(right(wmat,7))
	session("v_Usuario_Maquina") = Request.ServerVariables("REMOTE_ADDR")
	...
	Session("v_Usuario_Nome")= GetName
	If len(trim(GetName)) = 0 THEN
		...
		'Response.End
	End If
	Session("v_Usuario_CGC") = right(unid,4)
