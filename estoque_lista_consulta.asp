...
strQuery = 		"select MATERIAL.CO_MATERIAL, MATERIAL.NO_MATERIAL, MATERIAL.QT_QUANTIDADE, MATERIAL.QT_QTDE_MINIMA, MATERIAL.CO_UNIDADE, MATERIAL.CO_SIMAC, MATERIAL.DE_SIMAC, MATERIAL.QT_QTDE_SIMAC, MATERIAL.IC_ATIVO, UNIDADE.DE_UNIDADE from TB_ESTOQUE_MATERIAL AS MATERIAL JOIN TB_ESTOQUE_UNIDADE AS UNIDADE ON MATERIAL.CO_UNIDADE = UNIDADE.CO_UNIDADE WHERE MATERIAL.IC_ATIVO = 1"
...
'	if Pag = 0 then Pag = 1
	...
	Else
          ...
          response.write "<td width='7%'>Disponível</td>"
