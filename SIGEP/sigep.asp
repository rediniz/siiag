...
$("#qtd_arquivo").val(qtd_arquivos)
   ...
   if($("#cpfgts").val().length != 18)
   {
	 ...
	 $("#aviso").show();
	 $("#enviarArquivo").hide();
	 window.setInterval(formulario.submit(), 2000);
  } 
...
<div class='corpo'>
  <div class='conteudo' align="center" style="width:700px;">
    ...
    <div class="formulario" style="background-color:#FFF;padding-bottom:1%; padding-top:1%;  border-bottom: 1px solid #d0dada; border-top: 1px solid #d0dada;">
      <form  ACTION="upload_arquivo.asp" METHOD="POST" ENCtype="multipart/form-data" onSubmit="return valida()" name="formulario" id="formulario">
        <table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
          ...
          <tr>
            ...
            <td><div align="left"> <span class="formulario" style="background-color:#FFF; padding-top:3%;padding-bottom:1%;">
                <input type="text" id="cgc"  name="cgc"  value="7180" size="5" disabled="disabled"/>
                </span></div></td>
          </tr>
          <tr>
        ...
        <div align="center" id="aviso"> <img src='imagens/carregando.gif' />
		...
		response.write ("<script language=""javascript""> alert('Arquivo enviado com sucesso.'); </script>")
			
		else
		
		if( sucesso="false" ) then
		
		response.write ("<script language=""javascript""> alert('Erro ao enviar arquivo(s)'); </script>")
