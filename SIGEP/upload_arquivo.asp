...
<%
	...
	qtd_arquivo = CInt(objUpload("qtd_arquivo").Value)
	cpfgts =objUpload("cpfgts").Value
    ...
    quantidade = objUpload("quantidade"&i).Value
	...
	' Salva o arquivo na pasta
		arquivo.SaveAs(pasta2 & "\" & arquivo.FileName)
		end if
		next
