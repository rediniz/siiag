...
<%	
	...
	sub indicar()
		...
		queryIndicar = "insert into tb_colaboracao(indicado, quantidade_horas, pedido, inicio_colaboracao) values ('"&indicado&"', "&quantidadeHoras&","&pedido&",'"&date()&"')"
		'#ALTERADO EM 19/05/2016
		queryStatusPedido = "update tb_colaboracao_pedido set status = 2, data_inicio_colaboracao = '"&date()&"' where id = "&pedido&""
		
		objConn.execute(queryIndicar)
