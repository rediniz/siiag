...
%>
          ...
          <input type="text" class="form-field" name="qtd_participantes" id="qtd_participantes" style="width:25px;" size="3" maxlength="3"/>
          <p></p>
          <label for="desc_participantes">Descrição dos participantes:</label>
          <input type="text" class="form-field" name="desc_participantes" id="desc_participantes" style="width:410px;" maxlength="50px"/>
          <br/>
          <br/>
