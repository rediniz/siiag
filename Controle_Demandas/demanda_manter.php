  			...
  			<div class="container">
    			<div class="conteudo2">
      				...
      				<p>
      					<div id='cssmenu' >
        					<ul>
								...
								<li class='active'><a href='demanda_manter.php'><span>Manter Demandas</span></a></li>
    		 				</ul>
          				</div>
          			</p>
        			...
        			<fieldset class="testess"style=" border-color: #FFCC66; border:#FFCC66 1px solid; border-radius:4px;">
          				<legend><span class="titulos" >Manter Demanda</span></legend>
                            <table border="0">
                                <!-- abre tipos -->
                                		<?  
...
<!--                                    <input style="margin-top:5px; " class="form-field" name="nome" id="nomeSolicitante" type="text" size="43" maxlength="100" /></td></tr>-->
                             ...
                             <? 
								...
								$resultadoSituacao = mssql_query($querySituacao, $conexao);
                                 ...
                                 <tr> <td>&nbsp;   	</td> </tr>
                                 <tr> 
                   					<td style="display:none;" id="label3"><label> Estagi&aacute;rios:<? echo $linhaResponsaveis['MAT_ESTAGIARIO']; ?> </label></td>	
<?                                  //$linhaResponsaveis.moveToFirst;
									//mysql_data_seek($linhaResponsaveis,1);
									//for($i = mssql_num_rows($resultadoResponsaveis) -1; $i>=0; $i--){
									
									 ?>
                                    <td style="display:none; color:#666666" id="check1">
	                                        <input  type='checkbox' name='chk_matricula1' id='estagiarios1' value="E712237" <? if (strcasecmp(trim($linhaResponsaveis['MAT_ESTAGIARIO']),"e712237") == 0 or $a == 1) { ?> checked="checked" <? $a=1; } ?> /> Belmondo Rodrigues Arag&atildeo Junior  				
                                        
                                     </td>
                                     <td style="display:none; color:#666666" colspan="2" id="check2"> 
                                     	<input type='checkbox' name='chk_matricula2' id='estagiarios2' value="E689507" <? if (strcasecmp(trim($linhaResponsaveis['MAT_ESTAGIARIO']),"e689507") == 0 or $b == 1) { ?> checked="checked"<? $b=1; } ?> /> Nat&aacute;lia Albuquerque Cavalcante  
                                     </td> </tr>
                                  <tr>   
                                  	  <td>&nbsp; 	</td>
                                      <td style="display:none; color:#666666" id="check3"> 
                                     	<input type='checkbox' name='chk_matricula3' id='estagiarios3' value="E701082" <? if (strcasecmp(trim($linhaResponsaveis['MAT_ESTAGIARIO']),"e701082") == 0 or $c == 1) { ?> checked="checked" <? $c=1; } ?>/> Jonathan Garcia de Queiroz   
									
                                     </td>
                                     <td style="display:none; color:#666666" colspan="2" id="check4"> 
                                     	<input type='checkbox' name='chk_matricula4' id='estagiarios4' value="E711000"  <? if (strcasecmp(trim($linhaResponsaveis['MAT_ESTAGIARIO']),"e711000") == 0 or $d == 1) {  ?> checked="checked" <? $d=1; } ?> /> Renato Diniz Ferreira 
