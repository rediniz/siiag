...
<%
	...
	'redireciona para a página inicial informando sucesso
		...
		Response.Redirect("usuario.asp?sucesso=true&arquivo_pasta=" & pasta_guardar_2  & " &arquivo=" & nome_arquivo & "&f_matricula=" & matricula & "&f_nome=" & nome & "&f_coordenacao=" & coordenacao & "&f_cargo="& cargo & "&f_nascimento=" & nascimento & "&f_admissao=" & admissao & "&f_inicio=" & inicio & "&f_jornada=" & jornada & "&f_ativo=" & ativo & "&f_gerente=" & gerente)
